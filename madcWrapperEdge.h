...
#ifndef MADCWRAPPEREDGE
#define MADCWRAPPEREDGE
...
struct threadArguments{
  ...
  double cost_localCombine;
  double cost_waitingTime;
...
void* performEuclideanClustering_edge(void* );
void* performDBSCAN_edge(void* );

void performCombine(envMap*);
